          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                <h4>桌遊資訊</h4>
                <p class="m-0">
                  <a href="GameInfo.php" class="btn btn-primary px-4">點擊查看</a>
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                <h4>餐點瀏覽</h4>
                <p class="m-0">
                  <a href="MenuInfo.php" class="btn btn-primary px-4">點擊查看</a>
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                ...
                <p class="m-0">
                <p class="m-0">
                  <a href="CusInfo.php" class="btn btn-primary px-4">點擊查看</a>
                </p>
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                <h4>遊戲種類</h4>
                <p class="m-0">
                <a href="TypeInfo.php" class="btn btn-primary px-4">點擊查看</a>
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            >
              ...
              <div class="pl-4">
                <h4>顧客訂單</h4>
                <p class="m-0">
                <a href="OrderInfo.php" class="btn btn-primary px-4">點擊查看</a>
                </p>
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 pb-1">
            ...
            <i
              ...
              <div class="pl-4">
                <h4>顧客偏好</h4>
                <p class="m-0">
                <a href="CuspreferInfo.php" class="btn btn-primary px-4">點擊查看</a>
                </p>
              </div>
            </div>
          </div>

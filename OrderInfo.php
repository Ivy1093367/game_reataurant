...
<p class="section-title px-5">
    <span class="px-2">Oderlist Infomation</span>
</p>
</div>
<?php
...
if($result=mysqli_query($link, $SQL)){
    ...
    echo "<thead><tr><th>顧客編號</th><th>餐點編號</th><th>數量</th><th>花費</th><th></th></tr></thead><tbody>";
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo "<td><a href='Order_del.php?Cid=".$row['Cid']."'>刪除</a></td>";
        echo "</tr>";
    }
    echo "</tbody></table>";
}
